  ...
  return (
    <div className={className}>
      <Section>
        ...
        <p>Po pierwszym rzucie gracz może zapisać dowolne kości i rzucić ponownie pozostałymi kośćmi.
          Procedurę tę powtarza się po drugim rzucie. Gracz ma pełny wybór, którymi kośćmi rzucić. </p>
        <p></p>
      </Section>
      <Section>
        <h1>Szkoła</h1>
